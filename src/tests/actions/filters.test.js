...
test('should generate generate set end date object', () => {
...
test('should generate set text object with added values', () => {
...
test('should generate set text object with default values', () => {
